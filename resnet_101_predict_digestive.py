# -*- coding: utf-8 -*-
"""
# resnet_101_predict_digestive.py
# @Author       : yuanwenjin
...
def resnet101_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    model.load_weights('resnet_101_finetune_weights.h5', by_name=True)
...
if __name__ == '__main__':
    ...
    # Load our model
    MODEL = resnet101_model(img_rows=IMG_ROWS, img_cols=IMG_COLS, color_type=CHANNEL, \
                              num_classes=NUM_CLASSES)

    # 数据路径
    DIGESTIVE_DIR = u'/home/tensorflow/digestive_change'
    CLASSIFIED_DIR = u'/home/densenet/cnn_finetune-master/resnet_results_480_finetune'
    ...
    for data_dir in DATA_DIRS[94:96]:
