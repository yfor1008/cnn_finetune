...
def densenet169_model(img_rows, img_cols, color_type=1, nb_dense_block=4, growth_rate=32, \
    ...
    x_newfc = GlobalAveragePooling2D(name='pool'+str(final_stage))(tensor_x) # new max pooling layer
    x_newfc = Dense(num_classes, name='fc6')(x_newfc)
    x_newfc = Activation('softmax', name='prob')(x_newfc)
...
if __name__ == '__main__':
    ...
    # Load our model
    MODEL = densenet169_model(img_rows=IMG_ROWS, img_cols=IMG_COLS, color_type=CHANNEL, \
